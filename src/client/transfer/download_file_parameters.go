...
func (o *DownloadFileParams) WithFileID(fileID int64) *DownloadFileParams {
	o.SetFileID(fileID)
	return o
}

// SetFileID adds the fileId to the download file params
func (o *DownloadFileParams) SetFileID(fileID int64) {
	o.FileID = fileID
}
...
func (o *DownloadFileParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	// path param fileID
	if err := r.SetPathParam("fileID", swag.FormatInt64(o.FileID)); err != nil {
		return err
	}
