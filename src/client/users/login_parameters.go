...
// WithEmail adds the email to the login params
func (o *LoginParams) WithEmail(email string) *LoginParams {
	o.SetEmail(email)
	return o
}

// SetEmail adds the email to the login params
func (o *LoginParams) SetEmail(email string) {
	o.Email = email
}
