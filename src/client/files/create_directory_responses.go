...
func (o *CreateDirectoryReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 401:
		result := NewCreateDirectoryUnauthorized()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func (o *CreateDirectoryOK) Error() string {
	return fmt.Sprintf("[PUT /directory][%d] createDirectoryOK  %+v", 200, o.Payload)
}
func (o *CreateDirectoryOK) GetPayload() *models.Directory {
	return o.Payload
}
...
// NewCreateDirectoryUnauthorized creates a CreateDirectoryUnauthorized with default headers values
func NewCreateDirectoryUnauthorized() *CreateDirectoryUnauthorized {
	return &CreateDirectoryUnauthorized{}
}

/* CreateDirectoryUnauthorized describes a response with status code 401, with default header values.
...
func (o *CreateDirectoryUnauthorized) Error() string {
	return fmt.Sprintf("[PUT /directory][%d] createDirectoryUnauthorized ", 401)
}

func (o *CreateDirectoryUnauthorized) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *CreateDirectoryDefault) Error() string {
	return fmt.Sprintf("[PUT /directory][%d] createDirectory default  %+v", o._statusCode, o.Payload)
}
func (o *CreateDirectoryDefault) GetPayload() models.Error {
	return o.Payload
}
